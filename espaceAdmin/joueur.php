...
<div class="album py-5 bg-light">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Joueurs</h1>
                <a class="btn btn-primary text-white" href="nouveau_joueur.php">Ajouter</a>
                <table class="table" width="100%" height="auto">
                    ...
                    <?php foreach ($posts as $p) { ?>
                        <tr >
                            ...
                            <td><img src="/assets/photo/<?= $p['photo'] ?>" alt="" width="30px" height="30px"><?= $p['nom'].' '?><?= $p['prenom'] ?></td>
                            <td><a href="joueur_edit.php?id=<?php echo $p['id'] ?>" class="btn btn-warning text-white">Modifier</a></td>
                            <td>
                                <a href="joueur_sup.php?id=<?php echo $p['id'] ?>" class="btn btn-danger text-white">Supprimer</a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
