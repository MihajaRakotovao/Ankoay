...
<div class="album py-5 bg-light">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Articles</h1>
                <a class="btn btn-primary text-white" href="nouveau_article.php">Ajouter</a>
                <table class="table">
                    <thead>
                    <tr>
                        <th scope="col">#</th>
                    ...
                    <?php foreach ($posts as $p) { ?>
                        <tr>
                            ...
                            <td><img src="/assets/photo/<?= $p['photo'] ?>" alt="" width="30px" height="30px"><?= $p['titre'] ?></td>
                            <td><a href="admin_edit.php?id=<?php echo $p['id'] ?>" class="btn btn-warning text-white">Modifier</a></td>
                            <td>
